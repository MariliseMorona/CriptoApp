...
class CoinsListViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        listView.addDelegates(collectionDelegate: self, collectionDataSource: self, tableDelegate: self, tableDataSource: self)
        setup()
    }
    ...
    func doFetchListCoins(){
        let request = CoinsList.FetchListCoins.Request(baseCoin: "brl", orderBy: "market_cap_desc", top: 10, princePercentage: "1H")
